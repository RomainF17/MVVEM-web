...
export function RecommendationsPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-white to-purple-50/30 pt-24">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-purple-50/30 pt-24 pb-16">
      {/* Background decoration */}
      <div className="fixed top-0 left-1/4 w-96 h-96 bg-purple-100 rounded-full blur-3xl opacity-30 pointer-events-none" />
      <div className="fixed bottom-0 right-1/4 w-80 h-80 bg-pink-100 rounded-full blur-3xl opacity-30 pointer-events-none" />
