...
export const Mission = () => {
  return (
    <section id="mission" className="py-24 md:py-32 px-6 bg-neutral-50">
      <div className="container mx-auto max-w-4xl">
        ...
        >
          ...
          <motion.h2
            ...
            viewport={{ once: true }}
            className="text-3xl md:text-4xl lg:text-5xl font-display font-medium text-neutral-900 leading-[1.25] tracking-tight mb-12"
          >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="space-y-6 text-lg md:text-xl text-neutral-600 leading-relaxed max-w-3xl mx-auto"
          >
            <p>
